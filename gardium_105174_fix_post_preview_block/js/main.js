...
var ShowMore = {
	...
	initialize: function () {
		...
		} else if (this.$el.is('[data-block]')) {
			this.classNameElement = this.$el.data('block');
			console.log(this.classNameElement);
			this.replaceDefaultPagination('btn-shadow--' + this.classNameElement);
		} else {
